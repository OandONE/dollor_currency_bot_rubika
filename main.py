...
👾 {id_bot}""",message_click.chat_id)
        ...
        await bot.send_text("☎️ پشتیبانی : @O_and_ONE_01",message_click.chat_id)
    elif message_click.button_id=="104":
        await bot.send_text(f"📣 کانال : {id_channel}",message_click.chat_id)
